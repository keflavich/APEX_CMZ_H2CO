...
#
#with log.log_to_file(logfile.replace(".log","_only_clean_2013.log")):
#    make_apex_cubes.make_high_mergecube(pca_clean={'2014':False, '2013':True, 'ao':False},
#                                        scanblsub={'2014':False, '2013':False, 'ao':False},
#                                        timewise_pca={'2014':True, '2013':False, 'ao':False}, 
#                                        mergefile2='APEX_H2CO_merge_high_pca2013only')
