...
B2 and -90 \kms in Sgr A is a different line, HC$_3$N 24-23.
...
20 \kms and 12 pc of the orbital path.  There is a hint of a linear
...
proportional to the integrated \thirteenco 2-1 brightness and are meant to give
an inidication of how reliable the detections are; most of the detections below
$\lesssim40$ K are questionable.  The grey vertical lines through the circles
indicate the formal $1-\sigma$ errors on the temperature.}
...
analysis to ours but over a limited area.  They reported similar temperatures,
...
{figures/orbits/mydrawnpath_on_H2CO_TemperatureFromRatio_smooth_weighted.pdf}
