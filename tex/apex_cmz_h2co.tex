...
We determine the expected gas kinetic temperature
...
dendrogram-extracted clump within 35 \kms and 6 pc of the
\citet{Kruijssen2015a} orbit.  The possible linear increase in temperature over
the first $\sim0.5$ Myr might support the \citet{Kruijssen2015a} hypothesis
that the `ring' represents a single gas stream on its first passage by Sgr A*.
However, the `trend' is equally consistent with a constant temperature over the
same range.
...
(\citet{Wiesenfeld2013a} rather than \citet{Green1991a}).  The \citet{Ao2013a}
