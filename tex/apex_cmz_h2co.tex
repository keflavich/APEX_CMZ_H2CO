...
star formation deficit noted in \citet{Longmore2013b}, since the cool stream
does not appear to be actively star forming at present.  However, the total
...
The 100 \kms cloud stream extending from $\ell=1.2$ to $\ell=0.3$ is relatively
