...
(the velocity dispersion observed is not purely a gradient, and the size scale
observed could easily be wrong by a factor of 2-3 because of projection)
