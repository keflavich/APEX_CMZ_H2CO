...
\section{Signal Extraction for Integrated Maps}
\label{sec:signal}
...
\ref{sec:h2cotemmap}.  Regions of lower signal-to-noise, and therefore less
...
While $R2$ can, in some cases, provide significant constraints on various
