...
is a `leaf' and all associated larger structures are `ancestors'.
...
\percc), a fixed assumed line gradient of 5 \kms / pc, 30 \formaldehyde column
...
$\ell\gtrsim0.9\arcdeg$, the gas is uniformly $T\sim60$ K.  Similarly, most of the gas
