...
Brick' (G0.253+0.016, cloud a) through the lettered clouds \citep[clouds
b,c,d,e,f][]{Lis1999a}, ending at Sgr B2.
...
hydrodynamically unimportant.  \citet{Ao2013a} used the \para 220 GHz
...
resolution to make the data more manageable.  
...
and (b) a box centered on G0.42+0.03.
The fitted parameters shown in the legend are the amplitude of the
\formaldehyde \threeohthree line, the centroid velocity, the line width
($\sigma$, not FWHM), the ratio $R_1 = \Rone$,
the ratio $R_2 = \Rtwo$, and the amplitude of
the \methanol \fourtwotwo line.  
These spectra have significantly
...
The cooler gas on the far side does not obviously fit with this picture, 
