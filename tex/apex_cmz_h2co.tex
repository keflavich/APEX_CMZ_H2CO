...
nearby ($d\sim1-5$ kpc) clouds from clouds within the central kiloparsec.  Additionally,
...
These prior gas temperature measurements primarily used the popular ammonia
(\ammonia) metastable inversion transition thermometer, which is sensitive to
...
gas in which the excess energy from molecule formation leaves a significant fraction of the molecules
in a rotationally excited state \citep[][]{Lis2014a,Mills2013a}.
\citet{Ao2013a} used the \para 220 GHz thermometer \citep{Mangum1993a}, which
is sensitive to denser gas ($n\sim10^4-10^5$ \percc), and still found a
significant discrepancy between gas and dust temperature, but they only covered
the inner 75 pc.
...
The maps achieved a depth of $\sigma=50-80$ mK in 1 \kms channels.  The noise
is moderately lower (about 15\%) than expected from the online APEX calculator
because our noise measurements are made in moderately smoothed maps.
