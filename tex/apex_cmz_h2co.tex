...
$J=3-2$ para-formaldehyde (\para) transitions.  We use the 
\threetwoone / \threeohthree line ratio to determine the gas temperature in
$n\sim10^4-10^5$ \percc gas.  We produce temperature maps and cubes with
30\arcsec and 1 \kms resolution and publish all data in FITS form; they can be
recovered from digital object identifier \texttt{doi:10.7910/DVN/27601}.}
...
mechanism.  \citet{Ao2013a} used the para-formaldehyde (\para) 218 GHz
