...
\citet{Ao2013a} data but were in the newer XFFTS epoch data.  While we do
...
plausible and that the temperature does not differ very much as a function of
$R_1$ over the plausible range of densities.
}
...
observed line emission.  Regions within the actively star-forming regions
...
which is much lower than measured CRIRs in the CMZ.
...
\FigureTwo
{figures/chi2_temperature_vs_turbulenttemperature_fieldsandsources.pdf} %parameter_comparisons
%{figures/dendrotem/temperature_vs_turbtemperature.pdf} # dendrotem_plots
{figures/dendrotem/temperature_vs_Despoticturbtemperature.pdf} % dendrotem_plots
...
Taken at face value, this implies that both thermometers show increasing 
temperatures in starbursts, but they each trace different gas.
...
relative to its dense gas mass.  \citet{Kruijssen2014c} suggested that one of
...
in clump extraction, Padelis Papadopoulos for providing commentary on a draft
