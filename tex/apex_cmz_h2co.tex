...
{figures/big_maps/big_lores_smoothdens1e4_col5e22_weighted_masked_tmap_withcontours.pdf}
{figures/big_maps/big_lores_smoothdens1e5_col5e22_weighted_masked_tmap_withcontours.pdf}
{figures/big_maps/big_lores_smoothdens1e5_col3e23_weighted_masked_tmap_withcontours.pdf}
{\todo{Temperature maps assuming a fixed $N(\hh)$ and $n(\hh)$}
}
{fig:temmap}{1}{9.5in}
