...
temperatures given the observed line widths.  The predicted temperature assuming
standard cold cloud chemistry is often higher than the observed temperature, so
we propose that the hotter CMZ clouds are able to cool via line emission more
efficiently than local clouds.}
%{This is an abstract.}
%{To fill it in.}
...
than the dust-derived average density, which is not likely.
...
extrapolating our measurements to some degree.
...
temperature for our observations.  
