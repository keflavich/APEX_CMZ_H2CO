...
\todo{Questionable - not sure the temperature-Mach number correlation
is correct.  Remove this \& Figure \ref{fig:temvsfwhm_regions}?} In a
turbulent medium, the 1D line width of the gas at a fixed spatial scale should
be correlated with the 3D Mach number \citep[e.g.][]{Federrath2011a}.  If
...
However, Figure \ref{fig:temvsfwhm_regions} shows no such correlation.  There
may be a correlation in the dendrogram-extracted data, but it is weak.
...
in the dendrogram tree, while the opaque points show leaves.}
...
\citet{Kruijssen2015a} orbit.  The linear increase in temperature over the
...
20 \kms and 12 pc of the orbital path.  There is a \emph{hint} of an 
increase in temperature with time, from an initial temperature $T\lesssim50$ K
to $T\gtrsim100$ K over a period $\tau\sim0.5-1$ Myr, as illustrated by the
