...
$J=3-2$ para-formaldehyde (\para) transitions, which has critical and effective
densities both $n\gtrsim10^5$ \percc.}
...
dense gas.  Turbulent heating can readily
explain the observed temperatures given the observed line widths.  Cosmic rays
cannot explain the observed variation in gas temperatures, so CMZ cloud
temperatures are not dominated by cosmic ray heating.  The predicted
temperature assuming standard cold cloud chemistry is often higher than the
observed temperature, so the hotter CMZ clouds may be able to cool via line
emission more efficiently than local clouds.}
