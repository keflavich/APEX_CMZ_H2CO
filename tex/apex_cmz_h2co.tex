...
The dendrogram-extracted points \todo{cluster above the $T_{predicted} =
...
\todo{Nearly all of the high signal-to-noise measurements in the dendrogram sources
...
\todo{One other possibility is that the dendrogram source extraction approach has
...
\todo{We may be able to further constrain the heating mechanisms using this same data
...
\todo{Add some orbital motivation.  Search for a pattern?}
...
in Figure \ref{fig:kdltemvstime}.  \todo{We see a possible linear increase...} The possible linear increase in temperature
...
temperature over the same range. \todo{If the trend is real, it indicates
a stochastic driver for turbulence...}
