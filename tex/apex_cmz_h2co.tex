...
additional factor of 200.  The resulting data were decomposed into
eigenspectra, of which the 3 most correlated components were then set to zero.
These components visually match the baseline ripples rather well, and due to
the extreme smoothing (160 \kms resolution), no line information is lost.  The
selection of 3 components was determined empirically by examining the
eigenspectra; a test removing the first 10 components showed no significant
difference.

\Figure{figures/M-091.F-0019-2013-2013-06-08_PCA_high_diagnostic.png}
{The first 3 eigenspectra from an observation taken on DATE.}
{fig:eigenspectra}{1}{0}
...
To demonstrate the utility of the PCA subtraction approach described in Section
