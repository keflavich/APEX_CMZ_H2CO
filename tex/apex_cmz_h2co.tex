...
$T_{dust} \approx T_{gas}$ at high densities, while we show that $T_{gas} >
T_{dust}$; see Section\ref{sec:td_ne_tg}.}.
...
a measured $1-\sigma$ lower limit on the temperature $T>150$ K.  The gray
...
predicted temperature $T_{gas}=156$ K, but a measured temperature $T_{gas}=91$
...
equilibrium temperature is then $T_{gas}=114$ K.  While this temperature is
