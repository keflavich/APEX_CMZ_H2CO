...
\todo{The system temperature ranged from $120 < T_{sys} < 200$ K for the majority of
the observations, with a small fraction (...\%) in the range $200 < T_{sys} <
300$ K.  There were also a very small number with much higher system
temperatures, $300 < T_{sys} < 750$ K, but these are associated with
observations of the bright Sgr B2 continuum source.}
