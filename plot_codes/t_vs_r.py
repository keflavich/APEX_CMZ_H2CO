...
from temperature_cubes import tcube_dend, tcube_dend_smooth, tcube_direct, tcubesm_direct
...
for tcube,name in zip((tcube_dend, tcube_dend_smooth, tcube_direct, tcubesm_direct),
                      ('dend','dendsm','direct','directsm')):
    ...
    fig1.savefig(paths.fpath("temvslon/temperature_vs_longitude_bmean_{0}.png".format(name)))
    fig2.savefig(paths.fpath("temvslon/temperature_vs_radius_bmean_{0}.png".format(name)))
    fig3.savefig(paths.fpath("temvslon/temperature_vs_longitude_{0}.png".format(name)))
    fig4.savefig(paths.fpath("temvslon/temperature_vs_radius_{0}.png".format(name)))
