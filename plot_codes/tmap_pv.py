    ...
    for weight in ("_weight",""):
        for smooth in ("",):#("_smooth",""):#"_vsmooth"):
            ...
            for ftemplate,outtype in toloop:
                ...
                F.save(fpath("big_maps/pv_tmap{0}{2}{1}{3}.pdf".format(smooth, outtype, weight, vmax_str)))
                ...
                log.info("Saving " +
                         fpath("big_maps/pv_tmap{0}{2}{1}{3}_masked.pdf".format(smooth,
                                                                             outtype,
                                                                             weight, vmax_str)))
                F.save(fpath("big_maps/pv_tmap{0}{2}{1}{3}_masked.pdf".format(smooth,
                                                                           outtype,
                                                                           weight, vmax_str)))
                ...
                pl.savefig(fpath("big_maps/pv_wcsaxes_tmap{0}{2}{1}{3}_masked.pdf".format(smooth,
                                                                           outtype,
                                                                           weight, vmax_str)),
                           bbox_inches='tight'
                          )
