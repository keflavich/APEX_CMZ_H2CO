...
if __name__ == "__main__":
    ...
    pl.clf()
    ax = pl.gca()
    ax.loglog(linewidths*2.35, sonic_masses, linewidth=2, alpha=0.5, label="$M_{sonic}$")
    ax.loglog(linewidths*2.35, sonic_masses_high, linewidth=2, alpha=0.5, label="$M_{sonic}$ $h=20$")
    ax.loglog(linewidths*2.35, sonic_masses_pfivethirds, linewidth=2, alpha=0.5, label="$M_{sonic}$ $p=5/3$")
    ax.loglog(linewidths*2.35, jeans_masses, linewidth=2, alpha=0.5, label="$M_{Jeans,thermal}$")
    ax.loglog(linewidths*2.35, jeans_masses_high, linewidth=2, alpha=0.5, label="$M_{Jeans,thermal}$ $n=10^5$")
    ax.set_ylim(0.1,100)
