...
for smooth in ("","_smooth",):#"_vsmooth"):
    ...
    log.info(os.path.join(figurepath, 'big_lores{0}_tmap_withcontours.pdf'.format(smooth)))
    ...
    log.info(os.path.join(figurepath,'big_lores{0}_tmap_withtdustcontours.pdf'.format(smooth)))
