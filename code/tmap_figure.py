...
for smooth in ("","_smooth","_vsmooth"):
    ...
    F.save(os.path.join(figurepath, 'lores{0}_tmap_withcontours.png'.format(smooth)))
    ...
    F.save(os.path.join(figurepath,'lores{0}_tmap_withtdustcontours.png'.format(smooth)))
